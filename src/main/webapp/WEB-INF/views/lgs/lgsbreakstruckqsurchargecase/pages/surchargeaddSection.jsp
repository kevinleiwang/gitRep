...
<% Date nowDate = new Date(); %>
   <form id="inquiry_quote_add_form" name="inquiry_quote_add_form" valid
		action="${ctx}/lgsbreakstruckqsurchargecase/addListSection" method="POST">
		<sunivo:flushMessage />
		
		<table class="table table-bordered table-striped table_vam" id="dt_gal">
		<tr> 
			<td><span style="line-height:44px;">运输公司：</span><g:logisticsCompanySelect  cusLogisticType="05" name="carrier" style="width:150px;" required="true"/></td>
